    ...
    public class Adolescent extends Person {
        ...
        public Adolescent(String theName, int theAge, double theWeight, char theGender, String entertainment, String activity) {
         ...
         *
         * @partam newActivity The adolescent's new favorite activity.
         */
         ...
         *
         * @partam newActivity The adolescent's new favorite source of entertainment.
         */
